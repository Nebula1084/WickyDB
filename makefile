...
INTERPRETOR = Parser.o Expression.o Optimizer.o Plan.o Evaluator.o lex.yy.o y.tab.o
ALOGRITHM = BTree.o
...
Interpretor: Sql
	...
	g++ -c src/Interpretor/lex.yy.c -Iinclude 
	g++ -c src/Interpretor/y.tab.c -Iinclude
